...
class T5Conditioner(Conditioner):
    ...
    def __init__(
        ...
        formal_t5_model_name = t5_model_name
        for model in self.T5_MODELS:
            if t5_model_name.endswith(model):
                formal_t5_model_name = model
                break

        super().__init__(self.T5_MODEL_DIMS[formal_t5_model_name], output_dim, project_out=project_out)
